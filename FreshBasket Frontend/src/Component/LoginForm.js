...
function LoginForm() {
	...
	return (
		...
		<div style={{backgroundImage: 'url("https://cdn.dribbble.com/users/1397889/screenshots/4681866/fruits_panning_dribbble.gif")',backgroundSize: 'cover', backgroundRepeat: 'no-repeat', backgroundPosition: 'center center'}}>
			<Toaster
				position="top-center"
				reverseOrder={false}
				toastOptions={{
