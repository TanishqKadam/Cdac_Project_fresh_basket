...
function Register() {
    ...
    return (
        <div style={{backgroundImage: 'url("https://images.saymedia-content.com/.image/t_share/MTkzOTUzODU0MDkyODc5MzY1/particlesjs-examples.gif")',backgroundSize: 'cover', backgroundRepeat: 'no-repeat', backgroundPosition: 'center center'}}>
            ...
            <div className="text-center mt-4 text-muted" style={{backgroundColor: '#30c732'}}>
