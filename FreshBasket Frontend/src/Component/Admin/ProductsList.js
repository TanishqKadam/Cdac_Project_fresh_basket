...
function ProductsList() {
    ...
    return (
        <div style={{backgroundColor: 'lightgreen'}}>
                        ...
                        <tbody>
                            {
                                products.map(p => (
                                    <tr key={p.id}>
                                        ...
                                        <td>
                                            <figure>
                                                <img src={`http://localhost:8080/FreshBasket/admin/${p.id}`} alt='productImage' width={75} />
            ...
            <div className="text-center text-muted" style={{ marginTop: '100px', marginBottom: '35px', backgroundColor: '#30c732' }}>
