...
import com.freshbasket.repository.UserDetailsRepository;
...
public class UserServiceImpl implements UserService {
	...
	public CartItem AddToCart(Integer productid, Integer qty) {
		 ...
		 * return cartItem;
		 */
		String jpql = "SELECT NEW com.freshbasket.pojos.StockDetails(sd.id, sd.stockItem, sd.pricePerUnit) FROM StockDetails sd WHERE sd.id=:Id";
	...
	public List<OrderDetails> getOrder(Integer userId) {
		String jpql = "SELECT NEW com.freshbasket.pojos.OrderDetails(o.id, o.orderItem, o.quantity, o.amount, o.orders) FROM OrderDetails o "
