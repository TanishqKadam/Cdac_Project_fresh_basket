package com.freshbasket.newcontroller;
...
import com.freshbasket.newservice.AdminService;
import com.freshbasket.newservice.FarmerService;
import com.freshbasket.newservice.UserServiceImpl;
...
public class AdminController {
	...
	@Autowired
	private FarmerService f_service;
	...
	public ResponseEntity<?> UpdateUser(@PathVariable int userId, @RequestBody User user) {
		...
		User u = uService.getUserDetails(userId);
		if (u != null) {
